...
<li><a href="./detailoffurniture.php" class="con8">Surya
<div class="box" >More Info</div>
<img class="img" src="../images3/c (10).jpg" width="80% " height="20%">
...
<br><p id="v"> 9569493943</p>
                ...
                <li><a href="./detailoffurniture.php" class="con8">Surya
                    <div class="box" >More Info</div>
                    <img class="img" src="../images3/c (4).jpg" width="80% " height="40%">
                ...
                <li><a href="./detailoffurniture.php" class="con8">Table
                    <div class="box" >More Info</div>
                    <img class="img" src="../images3/c (13).jpg" width="80% " height="20%">
                    <p></button></p><p id="v"> Price Rs60</p>
                    <br><p id="v"> 9569493943</p>
                    </a><p href="./buy.php"><div class="box2">buy/rent</div></p>
                </li>
                <li><a href="./detailoffurniture.php" class="con8">chair
                <div class="box" >More Info</div>
                <img class="img" src="../images3/c (4).jpg" width="80% " height="20%">
                <p></button></p><p id="v"> Price Rs60</p>
            ...
            <li><a href="./detailoffurniture.php" class="con8">Table
            <div class="box" >More Info</div>
            <img class="img" src="../images3/c (5).jpg" width="80% " height="20%">
            <p></button></p><p id="v"> Price Rs60</p>
            <p id="v"> Rent Rs400 per month</p>
            <br><p id="v"> 9569493943</p>
            </a><div class="box2">buy/rent</div>
        ...
        <li><a href="./detailoffurniture.php" class="con8">Table
        <div class="box" >More Info</div>
        <img class="img" src="../images3/c (6).jpg" width="80% " height="20%">
        <p></button></p><p id="v"> Price Rs60</p>
        <p id="v"> Rent Rs400 per month</p>
        <br><p id="v"> 9569493943</p>
        </a><div class="box2">buy/rent</div>
    ...
    <li><a href="./detailoffurniture.php" class="con8">chair
    <div class="box" >More Info</div>
    <img class="img" src="../images3/c (7).jpg" width="80% " height="20%">
    <p></button></p><p id="v"> Price Rs600</p>
...
<li><a href="./detailoffurniture.php" class="con8">chair
<div class="box" >More Info</div>
<img class="img" src="../images3/c (8).jpg" width="80% " height="20%">
<p></button></p><p id="v"> Price Rs600</p>
<p id="v"> Rent Rs30 per day</p>
<br><p id="v"> 9569493943</p>
</a><div class="box2">buy/rent</div>
...
<li><a href="./detailoffurniture.php" class="con8">Chair
<div class="box" >More Info</div>
<img class="img" src="../images3/c (9).jpg" width="80% " height="20%">
<p></button></p><p id="v"> Price Rs600</p>
...
<li><a href="./detailoffurniture.php" class="con8">Table
<div class="box" >More Info</div>
<img class="img" src="../images3/c (11).jpg" width="80% " height="20%">
<p></button></p><p id="v"> Price Rs60</p>
<br><p id="v"> 9569493943</p>
</a><p href="./buy.php"><div class="box2">buy/rent</div></p>
</li>
...
<li><a href="./detailoffurniture.php" class="con8">Table
<div class="box" >More Info</div>
<img class="img" src="../images3/c (12).jpg" width="80% " height="20%">
<p></button></p><p id="v"> Price Rs60</p>
<p id="v"> Rent Rs400 per month</p>
<br><p id="v"> 9569493943</p>
</a><div class="box2">buy/rent</div>
