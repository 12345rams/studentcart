...
if($error == 0){
 ...
 if(in_array($img_ex_lc,$allowed_exs)){
  ...
  if($result){
    ...
    <h2>You are successfully payment</h2>
    <h3>Our team will conform </h3>
    <h3>You check status in dashboard</h3>
    <a href="/ram/parcials/upload.php">click to go home page</a>
  </div>
    </body>
    </html>
    ';
