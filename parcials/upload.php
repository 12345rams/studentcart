...
<?php
  ...
  echo '<script src="../static/responses.js"></script>
    ...
    <div class="containerx">
      <div class="brand-logo"><img src="../images3/logo.jpeg" width="100px" height="100px"></div>
      <div class="brand-title">Studentcart</div>
      <div class="brand-title">Add the items</div>
     
      
         <form name="form1" class="" action="./upload2.php" method="post" enctype="multipart/form-data">
      <h5 class="butt">Add another photo</h5>
            <div class="input-file-container">  
              <input type="file" name ="screenshotofordername">
              <input type="submit" id="butt" value="upload">
            </div>
     </form>
     <h5>Add details of product</h5><a href="./account3.php"><input type="submit" id="butt" value="Add detail"></a>
