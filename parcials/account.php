...
margin-top: -100px;
 ...
 justify-content: center;
        ...
        <div class="profile-card__img"><img src="../images/Untitled design.png" alt="profile card">'.$name.'</div><div class="profile-card-inf"><div class="conh"><div class="profile-card__name"> name:
                  <p>'.$name.'</p>
           <div>account no:
           <p>'.$ai.'</p>
           </div>
