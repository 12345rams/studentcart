...
<li><a href="./detailofmobile.php" class="con8">Samsung
...
<br><p id="v"> 9569493943</p>
                ...
                <li><a href="./detailofmobile.php" class="con8">Samsung
                    <div class="box" >More Info</div>
                    <img class="img" src="../images3/7 (4).jpg" width="80% " height="40%">
                ...
                <li><a href="./detailofmobile.php" class="con8">Oppo
                    <div class="box" >More Info</div>
                    <img class="img" src="../images3/7 (3).jpg" width="80% " height="20%">
                    <p></button></p><p id="v"> Price Rs60</p>
                    <br><p id="v"> 9569493943</p>
                    </a><p href="./buy.php"><div class="box2">buy/rent</div></p>
                </li>
                <li><a href="./detailofmobile.php" class="con8">Vivo
                <div class="box" >More Info</div>
                <img class="img" src="../images3/7 (4).jpg" width="80% " height="20%">
                <p></button></p><p id="v"> Price Rs60</p>
            ...
            <li><a href="./detailofmobile.php" class="con8">Vivo
            <div class="box" >More Info</div>
            <img class="img" src="../images3/7 (5).jpg" width="80% " height="20%">
            <p></button></p><p id="v"> Price Rs60</p>
            <p id="v"> Rent Rs400 per month</p>
            <br><p id="v"> 9569493943</p>
      </a><div class="box2" href="./buy.php">buy/rent</div>
        </li>
        <li><a href="./detailofmobile.php" class="con8">Infinix
        <div class="box" >More Info</div>
        <img class="img" src="../images3/7 (6).jpg" width="80% " height="20%">
        <p></button></p><p id="v"> Price Rs60</p>
        <p id="v"> Rent Rs400 per month</p>
        <br><p id="v"> 9569493943</p>
 </a><div class="box2" href="./buy.php">buy/rent</div>
    ...
    <li><a href="./detailofmobile.php" class="con8">Infinix
    <div class="box" >More Info</div>
    <img class="img" src="../images3/7 (7).jpg" width="80% " height="20%">
    <p></button></p><p id="v"> Price Rs600</p>
...
<li><a href="./detailofmobile.php" class="con8">oppo
<div class="box" >More Info</div>
<img class="img" src="../images3/7 (8).jpg" width="80% " height="20%">
<p></button></p><p id="v"> Price Rs600</p>
<p id="v"> Rent Rs30 per day</p>
<br><p id="v"> 9569493943</p>
 </a><div class="box2" href="./buy.php">buy/rent</div>
...
<li><a href="./detailofmobile.php" class="con8">oppo
<div class="box" >More Info</div>
<img class="img" src="../images3/7 (11).jpg" width="80% " height="20%">
<p></button></p><p id="v"> Price Rs60</p>
<br><p id="v"> 9569493943</p>
</a><p href="./buy.php"><div class="box2">buy/rent</div></p>
</li>
<li><a href="./detailofmobile.php" class="con8">vivo
<div class="box" >More Info</div>
<img class="img" src="../images3/7 (10).jpg" width="80% " height="20%">
<p></button></p><p id="v"> Price Rs60</p>
<p id="v"> Rent Rs400 per month</p>
<br><p id="v"> 9569493943</p>
 </a><div class="box2" href="./buy.php">buy/rent</div>
...
<li><a href="./detailofmobile.php" class="con8">vivo
<div class="box" >More Info</div>
<img class="img" src="../images3/7 (12).jpg" width="80% " height="20%">
<p></button></p><p id="v"> Price Rs60</p>
<p id="v"> Rent Rs400 per month</p>
<br><p id="v"> 9569493943</p>
